...
const vocabularyLibrary = {
  ...
  //PALAVRAS QUE ESCAPARAM
    ...
    "cada": { type: "pronome", def: "Cada um, todo individual", eng: "each/every" },
...
"maldade": { type: "substantivo", def: "Qualidade de mau, crueldade", eng: "wickedness/malice" },
"martelo": { type: "substantivo", def: "Ferramenta para pregar ou bater", eng: "hammer" },
"punho": { type: "substantivo", def: "Parte fechada da mão", eng: "fist" },
"assuntos": { type: "substantivo", def: "Temas, matérias", eng: "matters/subjects" },
"pergunta": { type: "substantivo", def: "Interrogação, questão", eng: "question" },
"ovelhinha": { type: "substantivo", def: "Pequena ovelha", eng: "little sheep" },
...
"graça": { type: "substantivo", def: "Elegância, encanto, charme", eng: "grace/charm" },
"compaixão": { type: "substantivo", def: "Sentimento de piedade pelo outro", eng: "compassion" },
"fragrância": { type: "substantivo", def: "Aroma agradável, perfume", eng: "fragrance" },
"tipo": { type: "substantivo", def: "Espécie, categoria, modelo", eng: "type/kind" },
"repente": { type: "substantivo", def: "Impulso repentino (de repente = suddenly)", eng: "sudden impulse" },
...
"toco": { type: "verbo", def: "Verbo TOCAR — faço contacto com", eng: "I touch" },
...
"conte-me": { type: "substantivo", def: "Narre-me", eng: "tell me" },
    ...
    "tornando": { type: "verbo", def: "Verbo TORNAR (gerúndio) — ficando, transformando", eng: "becoming" },
    "deixaria": { type: "verbo", def: "Verbo DEIXAR no futuro do pretérito", eng: "would let/leave" },
    "curvando": { type: "verbo", def: "Verbo CURVAR (gerúndio) — dobrando, inclinando", eng: "bending/leaning over" },
    "acredita": { type: "verbo", def: "Verbo ACREDITAR no presente (3ª pessoa)", eng: "believes" },
    "acredito": { type: "verbo", def: "Verbo ACREDITAR no presente (1ª pessoa)", eng: "I believe" },
    "conheço": { type: "verbo", def: "Verbo CONHECER no presente (1ª pessoa)", eng: "I know" },
    "cresce": { type: "verbo", def: "Verbo CRESCER no presente (3ª pessoa)", eng: "grows" },
    "ficarão": { type: "verbo", def: "Verbo FICAR no futuro do indicativo", eng: "will remain/become" },
    "ficado": { type: "verbo", def: "Verbo FICAR (particípio passado)", eng: "stayed/remained" },
    "sentia": { type: "verbo", def: "Verbo SENTIR no pretérito imperfeito", eng: "felt/sensed" },
    "serão": { type: "verbo", def: "Verbo SER no futuro do indicativo", eng: "will be" },
    "come": { type: "verbo", def: "Verbo COMER no presente (3ª pessoa)", eng: "eats" },
    "têm": { type: "verbo", def: "Verbo TER no presente (3ª pessoa plural)", eng: "have" },
    "houve": { type: "verbo", def: "Verbo HAVER no pretérito perfeito", eng: "there was" },
    "faz": { type: "verbo", def: "Verbo FAZER no presente (3ª pessoa)", eng: "makes/does" },
    ...
    "admiração": { type: "substantivo", def: "Sentimento de admirar", eng: "admiration" },
    ...
    "crescer": { type: "verbo", def: "Verbo CRESCER (infinitivo) — aumentar de tamanho", eng: "to grow" },
    "comecei": { type: "verbo", def: "Verbo COMEÇAR no pretérito perfeito (1ª pessoa)", eng: "I began/started" },
    "pegavam": { type: "verbo", def: "Verbo PEGAR no pretérito imperfeito — agarravam", eng: "took hold/rooted" },
    "eram": { type: "verbo", def: "Verbo SER no pretérito imperfeito (3ª plural)", eng: "were" },
    "morrido": { type: "verbo", def: "Verbo MORRER (particípio passado)", eng: "died" },
    "soprada": { type: "verbo", def: "Verbo SOPRAR (particípio) — levada pelo vento", eng: "blown/carried by wind" },
    "chegado": { type: "verbo", def: "Verbo CHEGAR (particípio passado)", eng: "arrived" },
    "deveria": { type: "verbo", def: "Verbo DEVER no futuro do pretérito", eng: "should/ought to" },
    "trabalhar": { type: "verbo", def: "Verbo TRABALHAR (infinitivo) — exercer atividade", eng: "to work" },
    "pôde": { type: "verbo", def: "Verbo PODER no pretérito perfeito (3ª pessoa)", eng: "could/was able to" },
    "objetou": { type: "verbo", def: "Verbo OBJETAR no pretérito perfeito — discordou", eng: "objected" },
    "virem": { type: "verbo", def: "Verbo VIR no subjuntivo presente", eng: "to come (subjunctive)" },
    "lidar": { type: "verbo", def: "Verbo LIDAR (infinitivo) — tratar, enfrentar", eng: "to deal with/handle" },
    "perturbou": { type: "verbo", def: "Verbo PERTURBAR no pretérito perfeito", eng: "disturbed" },
    "julgado": { type: "verbo", def: "Verbo JULGAR (particípio passado) — avaliado", eng: "judged" },
    "pega": { type: "verbo", def: "Verbo PEGAR (particípio feminino) — apanhada", eng: "caught/caught out" },
    "devia": { type: "verbo", def: "Verbo DEVER no pretérito imperfeito", eng: "should/was supposed to" },
    "vim": { type: "verbo", def: "Verbo VIR no pretérito perfeito (1ª pessoa)", eng: "I came" },
    "cheirar": { type: "verbo", def: "Verbo CHEIRAR (infinitivo) — sentir o aroma de", eng: "to smell" },
    "perfumou": { type: "verbo", def: "Verbo PERFUMAR no pretérito perfeito", eng: "perfumed/filled with scent" },
    "soube": { type: "verbo", def: "Verbo SABER no pretérito perfeito", eng: "knew/found out" },
    "buscá-la": { type: "verbo", def: "Verbo BUSCAR + pronome LA — ir buscar", eng: "to fetch her/it" },
    "amá-la": { type: "verbo", def: "Verbo AMAR + pronome LA — amá-la", eng: "to love her" },
    "escutar": { type: "verbo", def: "Verbo ESCUTAR (infinitivo) — ouvir com atenção", eng: "to listen" },
    "deixou": { type: "verbo", def: "Verbo DEIXAR no pretérito perfeito (3ª pessoa)", eng: "left/let" },
    "coloque": { type: "verbo", def: "Verbo COLOCAR no subjuntivo presente", eng: "put/place" },
    "nasci": { type: "verbo", def: "Verbo NASCER no pretérito perfeito (1ª pessoa)", eng: "I was born" },
    "pensar": { type: "verbo", def: "Verbo PENSAR (infinitivo) — refletir, considerar", eng: "to think" },
    "peço": { type: "verbo", def: "Verbo PEDIR no presente (1ª pessoa)", eng: "I ask/request" },
    ...
    "chateado": { type: "adjetivo", def: "Aborrecido, incomodado", eng: "annoyed/bothered" },
    "ressentido": { type: "adjetivo", def: "Que guarda mágoa, magoado", eng: "resentful" },
    "desajeitado": { type: "adjetivo", def: "Sem jeito, torpe", eng: "clumsy/awkward" },
    "pálido": { type: "adjetivo", def: "De cor esbranquiçada, sem cor", eng: "pale" },
    "longa": { type: "adjetivo", def: "De grande comprimento (feminino)", eng: "long" },
    "frágeis": { type: "adjetivo", def: "Delicadas, quebradiças", eng: "fragile" },
    "ingênuas": { type: "adjetivo", def: "Sem malícia, inocentes", eng: "naive/innocent" },
    "sujos": { type: "adjetivo", def: "Não limpos, manchados", eng: "dirty" },
    "feio": { type: "adjetivo", def: "Sem beleza, desagradável", eng: "ugly" },
    "vermelho": { type: "adjetivo", def: "Da cor do sangue", eng: "red" },
    "gordo": { type: "adjetivo", def: "Com muito peso corporal", eng: "fat" },
    "obscurecidas": { type: "adjetivo", def: "Tornadas escuras, encobertas", eng: "darkened/obscured" },
    "preso": { type: "adjetivo", def: "Travado, preso, sem soltar", eng: "stuck/trapped" },
    "preocupado": { type: "adjetivo", def: "Com preocupação, inquieto", eng: "worried/concerned" },
    "pura": { type: "adjetivo", def: "Sem mistura, simples", eng: "pure/sheer" },
    "total": { type: "adjetivo", def: "Completo, absoluto", eng: "total/complete" },
    "pouca": { type: "adjetivo", def: "Pequena quantidade (feminino)", eng: "little/few" },
    "sufocadas": { type: "adjetivo", def: "Abafadas, engolidas", eng: "stifled/choked" },
    "largado": { type: "adjetivo", def: "Abandonado, solto", eng: "let go/abandoned" },
    "consolado": { type: "adjetivo", def: "Confortado, aliviado", eng: "consoled/comforted" },
    ...
    "implacavelmente": { type: "advérbio", def: "Sem piedade, sem parar", eng: "implacably" },
    "extremamente": { type: "advérbio", def: "Em grau extremo, muito", eng: "extremely" },
...
"emocionante": { type: "adjetivo", def: "Que provoca emoção, fascinante", eng: "exciting/thrilling" },
"dita": { type: "adjetivo", def: "Mencionada, pronunciada (particípio de dizer)", eng: "said/spoken" },
"meticulosa": { type: "adjetivo", def: "Muito cuidadosa, precisa", eng: "meticulous" },
"imediato": { type: "adjetivo", def: "Sem demora, instantâneo", eng: "immediate/instant" },
"linda": { type: "adjetivo", def: "Bonita, bela (feminino)", eng: "beautiful/lovely" },
"envergonhada": { type: "adjetivo", def: "Com vergonha (feminino)", eng: "embarrassed/ashamed" },
...
"extraordinária": { type: "adjetivo", def: "Fora do comum", eng: "extraordinary" },
    ...
    "acerca": { type: "preposicao", def: "A respeito de, sobre", eng: "about/regarding" },
    "graças": { type: "preposicao", def: "Graças a — por causa de", eng: "thanks to" },
    "apesar": { type: "preposicao", def: "Apesar de — não obstante", eng: "despite/in spite of" },
